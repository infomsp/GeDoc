(function ($) {
    ...
    // setup menu
    var _Post = 'GeDoc/Content/wPaint/plugins/main/img/icons-menu-main.png';
    debugger;
  $.fn.wPaint.menus.main = {
    ...
    // extend cursors
  _Post = 'GeDoc/Content/wPaint/plugins/main/img/';
  $.extend($.fn.wPaint.cursors, {
      'default': {path: _Post + 'cursor-crosshair.png', left: 7, top: 7},
      dropper: { path: _Post + 'cursor-dropper.png', left: 0, top: 12 },
      pencil: { path: _Post + 'cursor-pencil.png', left: 0, top: 11.99 },
      bucket: { path: _Post + 'cursor-bucket.png', left: 0, top: 10 },
      eraser1: { path: _Post + 'cursor-eraser1.png', left: 1, top: 1 },
      eraser2: { path: _Post + 'cursor-eraser2.png', left: 2, top: 2 },
      eraser3: { path: _Post + 'cursor-eraser3.png', left: 2, top: 2 },
      eraser4: { path: _Post + 'cursor-eraser4.png', left: 3, top: 3 },
      eraser5: { path: _Post + 'cursor-eraser5.png', left: 3, top: 3 },
      eraser6: { path: _Post + 'cursor-eraser6.png', left: 4, top: 4 },
      eraser7: { path: _Post + 'cursor-eraser7.png', left: 4, top: 4 },
      eraser8: { path: _Post + 'cursor-eraser8.png', left: 5, top: 5 },
      eraser9: { path: _Post + 'cursor-eraser9.png', left: 5, top: 5 },
      eraser10: { path: _Post + 'cursor-eraser10.png', left: 6, top: 6 }
  });
  ...
  $.extend($.fn.wPaint.defaults, {
    ...
    strokeStyle: '#060606'  // start stroke style
  });
