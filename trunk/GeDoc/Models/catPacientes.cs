...
namespace GeDoc
{
    ...
    [Serializable()]  
    public class catPacientes : EntityObject
    {     
        ...
        [ScaffoldColumn(false)]
        public string pacDepto { get; set; }
     ...
     // [Required(ErrorMessage = "Debe ingresar el número de CUIL")]
      ...
      //  [ScaffoldColumn(false)]
        ...
        [Required(AllowEmptyStrings = false, ErrorMessage = "Debe seleccionar una Nacionalidad")]
        public Int16? paisId
        {
            get;
            set;
        ...
        [UIHint("GridForeignKeyComboBoxNull")]
        [Required(AllowEmptyStrings = false, ErrorMessage = "Debe seleccionar una Obra Social")]
       ...
       [ScaffoldColumn(false)]
        ...
        // [ScaffoldColumn(false)]
         ...
         public string csNombre
         {
          ...
          [ScaffoldColumn(false)]
          public string pacRiesgoCardiovascular
          {
              get;
              set;
          }
          ...
          [ScaffoldColumn(false)]
          public bool turTieneDiagnosticos
          {
              get;
              set;
          }
    ...
    /// <summary>
    /// Version minimizada de catPaciente.
    /// </summary>
    public class catPacienteMin
    {
        ...
        public string pacApellidoYNombre { get; set; }
        public int pacPadron { get; set; }
    }
}