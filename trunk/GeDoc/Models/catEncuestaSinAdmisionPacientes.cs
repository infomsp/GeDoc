 ...
 * -----------------------------------------------------------------------------------------------
 * 15/01/2016   Rolando Delgado     Implementación inicial.
 * -----------------------------------------------------------------------------------------------
*/
...
namespace GeDoc
{
    [KnownType(typeof(catEncuestaSinAdmisionPacientes))]
    [Serializable()]
    public class catEncuestaSinAdmisionPacientes : EntityObject
    {
        ...
        public Int32 tranId
        {
         ...
         [ScaffoldColumn(false)]
        public catEncuestaSinadmisionPersonas protur
        {
            get;
            set;
        }
