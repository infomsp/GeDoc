...
var simpleGallery_navpanel = {
    ...
    images: [GetPathApp('Content/YsaSS-images/previous.gif'), GetPathApp('Content/YsaSS-images/play.gif'), GetPathApp('Content/YsaSS-images/next.gif'), GetPathApp('Content/YsaSS-images/pause.gif')], //nav panel images (in that order)
...
function simpleGallery(settingarg) {
    ...
    // hide the panel by setting the height =0
    ...
    jQuery(document).ready(function($) {
        ...
        setting.$wrapperdiv = $('#' + setting.wrapperid).css({ position: 'relative', visibility: 'visible', background: 'white', overflow: 'hidden', width: '99.5%' , height: setting.dimensions[1] }).empty() //main gallery DIV
...
//add alternate text
    ...
    layerHTML += '<img title="' + imgelement[3] + '" alt="' + imgelement[3] + '"  src="' + imgelement[0] + '" style="border-width:0; width: 100%; height: 500px;" />'
