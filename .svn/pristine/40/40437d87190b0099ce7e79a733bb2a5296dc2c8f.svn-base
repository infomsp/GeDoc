module.exports = function(grunt) {
  grunt.initConfig({
    ...
    uglify: {
      ...
      my_target: {
        files: {
          'wPaint.min.js': ['src/wPaint.js', 'wPaint.utils.js'],
    ...
    stylus: {
      compile: {
        ...
        files: {
            '../../Content/wPaint/wPaint.min.css': '../../Content/wPaint/wPaint.css'
        }
      }
    },
    concat: {
      basic_and_extras: {
        files: {
          ...
          'wPaint-min.css': ['../../Content/wPaint/lib/wColorPicker.min.css', '../../Content/wPaint/wPaint.min.css'],
        },
      }
    },
    watch: {
      files: [
        '../../Content/wPaint/wPaint.css',
        'wPaint.js',
